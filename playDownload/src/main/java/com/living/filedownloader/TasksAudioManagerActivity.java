    ...
    public static class TasksManager {
        private final static class HolderClass {
            private final static TasksManager INSTANCE
                    = new TasksAudioManagerActivity.TasksManager();
        }
        ...
        private void registerServiceConnectionListener(final WeakReference<TasksAudioManagerActivity>
        ...
        public void onCreate(final WeakReference<TasksAudioManagerActivity> activityWeakReference) {
