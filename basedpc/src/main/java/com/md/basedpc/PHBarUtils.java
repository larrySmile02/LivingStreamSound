...
public class PHBarUtils {
    ...
    public static void setStatusBarWrite(Activity activity) {
        setStatusBarWrite(activity, true);
    }

    /**
     * 设置状态栏颜色为白色
     * @param activity
     * @param isImmersive 是否为沉浸式
     */
    public static void setStatusBarWrite(Activity activity, boolean isImmersive) {
        if (activity == null)
            return;
        if (isImmersive) {
    ...
    public static void setStatusBarBlack(Activity activity) {
        setStatusBarBlack(activity, true);
    }
     ...
     * @param isImmersive 是否为沉浸式
     */
    public static void setStatusBarBlack(Activity activity, boolean isImmersive) {
        if (activity == null)
            return;
        if (isImmersive) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
     ...
     * @param isImmersive 是否为沉浸式
     */
    public static void setImmersive(Context context, boolean isImmersive) {
        if (context == null)
            return;
