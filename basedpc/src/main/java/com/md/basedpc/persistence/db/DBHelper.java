...
public class DBHelper extends SQLiteOpenHelper {
     ...
     * 数据库更新监听器
     */
    private com.md.basedpc.persistence.db.SQLiteDatabase.DBUpdateListener mTadbUpdateListener;
     ...
     */
    public DBHelper(Context context, String name, SQLiteDatabase.CursorFactory factory,
                    int version, com.md.basedpc.persistence.db.SQLiteDatabase.DBUpdateListener tadbUpdateListener) {
        super(context, name, factory, version);
        // TODO Auto-generated constructor stub
     ...
     * 设置数据库更新监听器
     */
    public void setOndbUpdateListener(com.md.basedpc.persistence.db.SQLiteDatabase.DBUpdateListener tadbUpdateListener) {
        this.mTadbUpdateListener = tadbUpdateListener;
    }
