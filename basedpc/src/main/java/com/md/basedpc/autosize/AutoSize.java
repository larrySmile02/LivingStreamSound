...
/**
 * ================================================
 * AndroidAutoSize 用于屏幕适配的核心方法都在这里, 核心原理来自于 <a href="https://mp.weixin.qq.com/s/d9QCoBP6kV9VSWvVldVVwA">YXT官方适配方案</a>
 ...
 * 既然选择, 就不要抱怨, 感谢 YXT技术团队 和 张鸿洋 等人对 Android 屏幕适配领域的的贡献
 * <p>
 *
 * @author wanggq
...
public final class AutoSize {
    ...
    /**
     * 使用 {@link Activity} 或 { android.support.v4.app.Fragment} 的自定义参数进行适配
     *
     * @param activity    {@link Activity}
     * @param customAdapt {@link Activity} 或 {ink android.support.v4.app.Fragment} 需实现 { CustomAdapt}
     */
    ...
    /**
     * 使用外部三方库的 {@link Activity} 或 { android.support.v4.app.Fragment} 的自定义适配参数进行适配
     *
     * @param activity          {@link Activity}
     * @param externalAdaptInfo 三方库的 {@link Activity} 或 { android.support.v4.app.Fragment} 提供的适配参数, 需要配合 { ExternalAdaptManager#addExternalAdaptInfoOfActivity(Class, ExternalAdaptInfo)}
     */
    ...
    /**
     * 这里是YXT适配方案的核心代码, 核心在于根据当前设备的实际情况做自动计算并转换 {@link DisplayMetrics#density}、
     ...
     * @see <a href="https://mp.weixin.qq.com/s/d9QCoBP6kV9VSWvVldVVwA">YXT官方适配方案</a>
     */
