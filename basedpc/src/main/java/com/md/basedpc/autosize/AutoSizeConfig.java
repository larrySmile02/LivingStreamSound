...
import com.md.basedpc.autosize.external.ExternalAdaptManager;
import com.md.basedpc.autosize.unit.UnitsManager;
import com.md.basedpc.autosize.utils.AutoSizeLogUtils;
import com.md.basedpc.autosize.utils.Preconditions;
import com.md.basedpc.autosize.utils.ScreenUtils;
...
public final class AutoSizeConfig {
     ...
     * 设计图上的总宽度, 单位 dp
     */
    private int mDesignWidthInDp = 1080;
    /**
     * 设计图上的总高度, 单位 dp
     */
    private int mDesignHeightInDp = 1920;
    /**
     * 设备的屏幕总宽度, 单位 px
     */
     ...
     * @param strategy      AutoAdaptStrategy, 传 {@code null} 则使用 { DefaultAutoAdaptStrategy}
     */
    AutoSizeConfig init(final Application application, boolean isBaseOnWidth, AutoAdaptStrategy strategy) {
        ...
        mScreenWidth = (mScreenWidth < mScreenHeight ? mScreenWidth : mScreenHeight);
        mScreenHeight = (mScreenWidth > mScreenHeight ? mScreenWidth : mScreenHeight);


        mStatusBarHeight = ScreenUtils.getStatusBarHeight();
        AutoSizeLogUtils.d("designWidthInDp = " + mDesignWidthInDp + ", designHeightInDp = " + mDesignHeightInDp + ", screenWidth = " + mScreenWidth + ", screenHeight = " + mScreenHeight);
...
//            }
//        });
        AutoSizeLogUtils.d("initDensity = " + mInitDensity + ", initScaledDensity = " + mInitScaledDensity);
    ...
    /**
     * { ExternalAdaptManager} 用来管理外部三方库 {@link Activity} 的适配
     *
