...
public final class AutoSizeCompat {
     ...
     *
     * @param resources   {@link Resources}
     * @param customAdapt {@link Activity} 或 { android.support.v4.app.Fragment} 需实现 {@link CustomAdapt}
     */
    ...
    /**
     * 这里是适配方案的核心代码, 核心在于根据当前设备的实际情况做自动计算并转换 {@link DisplayMetrics#density}、
